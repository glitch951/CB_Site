...
(function () {
  ...
  var CSS = [
    '#askchris { --ac-paper: #fbf8e5; --ac-ink: #020E16; --ac-orange: #DB5B2C;',
    '  --ac-rule: rgba(2,14,22,.15); font-family: "Figtree", "Avenir Next", sans-serif;',
    ...
    '  padding: 16px 18px; }',
    '.ac-top:hover .ac-title { color: var(--ac-orange); }',
    '.ac-title { font-size: 19px; font-weight: 800; letter-spacing: -.02em;',
    '  margin: 0 0 6px; transition: color .15s ease; }',
    '.ac-meta { font-size: 11.5px; font-weight: 300; letter-spacing: .08em;',
    '  text-transform: uppercase; opacity: .55; }',
    '.ac-meta b { font-weight: 600; color: var(--ac-orange); opacity: 1; }',
    '.ac-preview { font-family: Georgia, "Source Serif 4", serif; font-size: 15px;',
    '  line-height: 1.5; opacity: .75; margin: 8px 0 0; display: -webkit-box;',
    ...
    '.ac-msg.is-chris::before { background: var(--ac-orange); }',
    '.ac-who { font-size: 11.5px; font-weight: 600; letter-spacing: .14em;',
    '  text-transform: uppercase; margin: 0 0 6px; opacity: .75; }',
    '.ac-msg.is-chris .ac-who { color: var(--ac-orange); opacity: 1; }',
    '.ac-who small { font-weight: 300; letter-spacing: .06em; opacity: .6;',
    '  text-transform: none; margin-left: 10px; }',
    '.ac-text { font-family: Georgia, "Source Serif 4", serif; font-size: 16px;',
    '  line-height: 1.62; }',
    '.ac-text p { margin: 0 0 10px; } .ac-text p:last-child { margin-bottom: 0; }',
    '.ac-text a { color: var(--ac-orange); }',
  ...
  function render(root, data) {
    ...
    threads.forEach(function (t) { root.appendChild(renderThread(t)); });
  }
